# CC-SYS-PROMPT-05-10-26 (Part 1 of 3)
...
- subagent_type (string, enum): The type of specialized agent to use - "sonnet", "opus", "haiku"
- model (string, enum): Optional model override - "sonnet", "opus", "haiku"
- isolation (string, enum): Isolation mode - "worktree"
...
- limit (integer, exclusive min 0): The number of lines to read
