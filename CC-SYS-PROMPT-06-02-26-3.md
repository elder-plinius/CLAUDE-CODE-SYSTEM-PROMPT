# CC-SYS-PROMPT-06-02-26 (Part 3 of 3)
...
**elder-plinius/CLAUDE-CODE-SYSTEM-PROMPT**: Develop on branch `claude/laughing-ride-c6TYU`
...
The following MCP GitHub tools are available (schemas loaded via ToolSearch):
