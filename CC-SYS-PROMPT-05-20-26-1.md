# CC-SYS-PROMPT-05-20-26 (Part 1 of 3)
...
Parameters: description (string, required), isolation ("worktree"), model (sonnet/opus/haiku), prompt (string, required), run_in_background (boolean), subagent_type (string).
...
3. Run the following commands in parallel:
   ...
   https://claude.ai/code/session_01Cq5YfFDpqPvLgAmzcR64Yu
...
Parameters: command (string, required), dangerouslyDisableSandbox (boolean), description (string), run_in_background (boolean), timeout (number).
