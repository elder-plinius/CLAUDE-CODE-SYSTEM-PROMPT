 ...
 **elder-plinius/CLAUDE-CODE-SYSTEM-PROMPT**: Develop on branch `claude/laughing-ride-AkAM0`
...
## Additional System Prompt Context (from {antml:thinking_mode} and {antml:reasoning_effort} tags)
