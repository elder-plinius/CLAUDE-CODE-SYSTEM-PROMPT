...
[Tool definitions for: Agent, Artifact, Bash, Edit, Glob, Grep, ListAgents, PushNotification, Read, ReadNotifications, ReportFindings, ScheduleWakeup, SendUserFile, ShowOnboardingRolePicker, Skill, SuggestSkills, ToolSearch, Workflow, Write — each with full JSON Schema parameters as documented in the system prompt.]
...
`/tmp/claude-0/-home-user-CLAUDE-CODE-SYSTEM-PROMPT/6e590a98-ca04-5056-b44c-92027b197628/scratchpad`
